...
@Mixin(value = GuiExPatternTerminal.class, priority = 900)
public class HelperExAccessScreen<TMenu extends ContainerExPatternTerminal> extends AEBaseScreen<TMenu> {
