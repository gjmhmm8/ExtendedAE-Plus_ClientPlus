...
class LangZH(output: PackOutput) : LanguageProvider(output, ExtendedAEPlusClient.MODID, "zh_cn") {
    override fun addTranslations() {
        ...
        UtilKeyBuilder.ofDataGen(UtilKeyBuilder.config)
            .addStr("title")
            .buildInto("ExtendedAE Plus [ClientPlus] 配置")
        UtilKeyBuilder.ofDataGen(UtilKeyBuilder.config)
            .addStr("category")
            .addStr("client")
            .buildInto("客户端")
        UtilKeyBuilder.ofDataGen(UtilKeyBuilder.config)
            ...
            .branch("tooltip", "每次自动转移步骤之间的延迟刻数")
            .buildInto("自动转移延迟")
        UtilKeyBuilder.ofDataGen(UtilKeyBuilder.config)
            .addStr("autoUploadMode")
            .branch("tooltip", "编码选择供应器后的行为")
            .branch("NONE", "不处理")
            .branch("WHEN_OPEN", "打开时上传")
            .branch("AUTO_OPEN", "自动打开并上传")
            .branch("EAEP_BY_NAME", "EAEP 按名称上传")
            .buildInto("自动上传模式")
        UtilKeyBuilder.ofDataGen(UtilKeyBuilder.config)
            .addStr("encodingTiggerMode")
            .branch("tooltip", "编码后自动选择供应器的触发键模式")
            .buildInto("编码触发模式")
        UtilKeyBuilder.ofDataGen(UtilKeyBuilder.config)
            .addStr("itemEditingTiggerMode")
            .branch("tooltip", "物品属性编辑界面的触发键模式")
            .buildInto("物品编辑触发模式")
        UtilKeyBuilder.ofDataGen(UtilKeyBuilder.config)
            .addStr("autoEncodingTiggerMode")
            .branch("tooltip", "自动链式编码的触发键模式")
            .buildInto("自动编码触发模式")
        UtilKeyBuilder.ofDataGen(UtilKeyBuilder.config)
            .addStr("tiggerMode")
            .branch("ON_SHIFT", "按住 Shift")
            .branch("ON_NOT_SHIFT", "未按 Shift")
            .branch("ON_CTRL", "按住 Ctrl")
            .branch("ON_NOT_CTRL", "未按 Ctrl")
            .branch("ON_ALT", "按住 Alt")
            .branch("ON_NOT_ALT", "未按 Alt")
            .branch("NONE", "禁用")
            .buildInto("触发模式")
        UtilKeyBuilder.ofDataGen(UtilKeyBuilder.config)
            .addStr("modeEncodingTransfer")
